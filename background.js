...
var DefaultSettings = {
        'active': false,
        'urls': ['https://openapi.gbis.go.kr/ws/rest/busrouteservice/*'], //['*://*/*'],
        'exposedHeaders': '',
        'Origin': 'https://openapi.gbis.go.kr/ws/rest/busrouteservice/'
    },
...
var requestRules = [{
    'data': {
        'name': 'Origin',
        'value': 'https://openapi.gbis.go.kr/ws/rest/busrouteservice/#auto/'
    },
    'mandatory': true,
    'fn': null
}, {
